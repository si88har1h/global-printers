...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/garment-tags-printing",
  },
  openGraph: {
    ...
    url: "https://globalprinters.in/garment-tags-printing",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Garment Tags & Clothing Tags in Bhilwara — Global Printers",
      },
    ],
  },
};
  ...
  return (
    <>
                ...
                itemListElement: [
                  {
                    ...
                    position: 1,
                    name: "Home",
                    item: "https://globalprinters.in",
                  },
                  {
                    "@type": "ListItem",
                    position: 2,
                    name: "Garment Tags Printing",
                    item: "https://globalprinters.in/garment-tags-printing",
                  },
                ],
              },
            ],
      ...
      <ServicePageLayout
        ...
        features={[
          {
            label: "Standard 55×90mm & Custom Sizes",
            detail:
              "The industry-standard hang tag size is 55×90mm. We also print 50×80mm, 60×100mm, and fully custom die-cut shapes to match your brand identity. Custom sizing at no extra charge for orders above 500 pieces.",
          },
          {
            label: "300–350 GSM Art Card & Kraft",
            detail:
              "Premium 300 GSM art card for sharp, vibrant colour reproduction. 350 GSM textured stock for a premium hand feel. Kraft board for eco-conscious brands. All substrates are suitable for foiling and embossing.",
          },
          {
            label: "Foil Stamping & Embossing",
            detail:
              "Gold and silver foil stamping for luxury brand positioning. Blind embossing for subtle tactile logos. Spot UV to highlight key design elements. Combine finishes for a premium multi-effect tag.",
          },
          {
            label: "Eyelet Punching & String Attachment",
            detail:
              "Metal eyelet punching in standard 4mm or custom sizes. String attachment available in cotton, jute, or synthetic cord. Ready-to-attach tags dispatched directly to your production line.",
          },
          {
            label: "Barcode & Serial Number Printing",
            detail:
              "Variable data printing for barcodes, QR codes, and serial numbers. Compatible with standard retail barcode formats (EAN-13, UPC-A). Essential for inventory management and retail compliance.",
          },
          {
            label: "MOQ 500, Pan-India Delivery",
            detail:
              "Minimum order 500 garment tags or clothing tags. Bhilwara-based production gives you metro-quality output at a lower cost base — we deliver directly to your factory floor, warehouse, or fulfillment partner across India.",
          },
        ]}
